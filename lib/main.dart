...
class WeeklyForecastList extends StatelessWidget {
          ...
          return Card(
            child: Row(
              children: <Widget>[
                ...
                weatherForecast(dailyForecast, currentDate, textTheme),
                weatherTemps(dailyForecast, textTheme),
              ],
            ),
          );
        },
  ...
  Widget weatherTemps(DailyForecast dailyForecast, TextTheme textTheme) {
    return Padding(
  ...
  Widget weatherForecast(DailyForecast dailyForecast, DateTime currentDate, TextTheme textTheme) {
    return Expanded(
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Column(
